...
> 状态：M0 完成（类型契约、状态机、Localizer Facade），M1.1 PoseGate 进行中（其余尚未实施）
...
| 里程碑 | 状态 | 当前证据/下一步 |
|---|---|---|
| M0 API/状态机 | 完成 | M0.1/M0.2/M0.3 全部落地（契约 19 + 状态机 24 + Facade 16 项测试，5/5 CTest 全过）；下一步 M1.1 PoseGate |
